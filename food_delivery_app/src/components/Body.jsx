  ...
  return (
    <div>
      <div className="body_component">
        <div className="search_bar">*Search bar coming up*</div>
          ...
          {resObj.map((i) => {
            return (
              <Restaurant_card
                ...
                resObj={i}
                name={i.data.name}
                cuisines={i.data.cuisines}
                avgRating={i.data.avgRating}
                deliveryTime={i.data.deliveryTime}
                costForTwoString={i.data.costForTwoString}
                cloudinaryImageId={i.data.cloudinaryImageId}
              ></Restaurant_card>
            );
          })}
        </div>
